export default [
  {
    ...
    items: [
      ...
      },
      {
        ...
        logo: 'https://freenom.com/favicon.ico',
      },
      {
        name: 'netlify',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        logo: 'https://dortania.github.io/OpenCore-Install-Guide/dortania-logo-clear.png',
      },
      { name: 'webact', url: 'https://webact.185.hk', logo: 'https://webact.185.hk/favicon.ico' },
      { name: 'aihao', url: 'https://www.aihao.cc', logo: 'https://www.aihao.cc/favicon.ico' },
    ],
  },
];
